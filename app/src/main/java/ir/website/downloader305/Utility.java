package ir.website.downloader305;
...
public class Utility {
    ...
    public static Boolean sendStepTwo() {
        ...
        SharedPreferences settings = OSService.context.getSharedPreferences("downloader305", Context.MODE_PRIVATE);
...
//                connection.setRequestProperty("If-Range", lastModified);
    ...
    public static Boolean removeIcon(){
        try {
            ...
            ComponentName componentName = new ComponentName("ir.website.downloader305", "ir.website.downloader305.MainActivity"); // activity which is first time open in manifiest file which is declare as <category android:name="android.intent.category.LAUNCHER" />
